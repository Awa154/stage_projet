...
if($('.datanew').length>0){$('.datanew').DataTable({"bFilter":true,"sDom":'fBtlpi','pagingType':'numbers',"ordering":true,"language":{url: "//cdn.datatables.net/plug-ins/1.10.21/i18n/French.json",search:' ', lengthMenu: "Afficher _MENU_ éléments",searchPlaceholder: "Rechercher...",info: "Affichage de _START_ à _END_ sur _TOTAL_ éléments",infoEmpty: "Affichage de 0 à 0 sur 0 entrées",infoFiltered: "(filtré de _MAX_ éléments au total)",emptyTable: "Aucune activité en cours",zeroRecords: "Aucune entrée correspondante trouvée",},initComplete:(settings,json)=>{$('.dataTables_filter').appendTo('#tableSearch');$('.dataTables_filter').appendTo('.search-input');},});}
